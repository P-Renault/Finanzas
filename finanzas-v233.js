...
(() => {
  ...
  async function saveDebt(e){
    ...
    /*
     * B231.2:
     * si está activa la opción "sin fecha",
     * no se asigna primera cuota ni próximo pago.
     *
     * Se consulta al momento de guardar para
     * ser compatible con el componente existente.
     */
    ...
    if(
      ...
      $('deudasMsg').textContent=
        'Para una deuda en cuotas debes indicar número de cuotas y cuota acordada.';
     ...
     */
      ...
      /*
       * SOLAMENTE CUOTAS generan plan.
       *
       * Una deuda UNICO jamás entra aquí.
       */
      ...
      if(
        ...
        try{
          ...
          $('deudasMsg').textContent=
            'Deuda creada, pero el plan no pudo generarse: '+
            x.message;
      ...
      id
        ...
        :
          (
            modalidad==='UNICO'
              ?
                'Deuda de pago único registrada.'
              :
                'Deuda registrada con plan de cuotas.'
          );
    ...
    async id=>{
      ...
      $('deudaDetalle').innerHTML=`
        ...
        <div class="detail-actions">
          ...
          <button
            onclick="window.reconstruirPlan23()">
            ${plan
              ?
                'Reconstruir plan'
              :
  ...
  /*
   * ============================================================
   * CONFIGURACIÓN DEL FORMULARIO DE DEUDAS
   * ============================================================
   */
  ...
  function setupDebtForm(){
    ...
    const est=()=>{
      ...
      /*
       * Nunca calcular cuota para
       * una deuda de pago único.
       */
    ...
    /*
     * IMPORTANTE:
     * una deuda nueva parte como UNICO.
     */
    setDebtModality(
      'UNICO'
    )
