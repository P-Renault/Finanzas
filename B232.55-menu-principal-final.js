...
var VERSION='B232.55-MENU-FINAL';
...
function db(){
  ...
  if(u&&k&&window.supabase&&window.supabase.createClient){
    try{return window.supabase.createClient(u,k,{auth:{persistSession:false,autoRefreshToken:false}})}catch(e){console.error('[B232.55] Supabase',e)}
  }
  return null;
}
