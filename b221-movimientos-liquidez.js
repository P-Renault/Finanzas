...
const getDb=()=>window.db||window.__db||(window.supabase&&localStorage.getItem('sf_url')?window.supabase.createClient(localStorage.getItem('sf_url'),localStorage.getItem('sf_key'),{auth:{persistSession:false,autoRefreshToken:false}}):null);
let accounts=[];
